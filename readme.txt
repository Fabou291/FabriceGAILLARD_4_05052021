...
permettant d'améliorer au mieux le referancement (pincipalement SEO donc), en prétant attention
également qu'il y en ai une pour les performances du site et une pour l'accessibilité.
...
1. Réduire le temps de chargement du site : (violet) (expliquer pourquoi c'est important pour chaque section)
    ligne 4, 23, 24, 25

2. Optimisation des balise d'en têtes : (vert)
    ligne 2, 3, 6, 7 un petit bout de 16 (keyword)

3. Eviter toutes les technique black hat - mal percue par google (bleu)
    ligne 16, 19

4. Adopter une structure des pages optimale (red)
    ligne 8, 9
